...
export default function FileDropModal({ show, onClose, onAdd }: FileDropModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-[2px] p-4">
      <div className="bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-lg relative animate-fadein">
        {/* 모달 헤더 */}
        ...
        <div className="px-6 py-5">
          <input
            ...
            autoFocus
            className="w-full rounded-lg border border-slate-300 px-3.5 h-11 text-sm font-mono text-slate-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition"
          />
